...
public class MonthInfo {
    ...
    private String TTen="null";
    private String TEleven="null";
    private int absent;
    private int present;
    private int leave;
    private int halfDay;
    ...
    public void setTSeven(String TSeven) {
        this.TSeven = TSeven;
    }

    public String getTEight() {
        return TEight;
    }

    public void setTEight(String TEight) {
        this.TEight = TEight;
    }

    public String getTNine() {
        return TNine;
    }

    public void setTNine(String TNine) {
        this.TNine = TNine;
    }
    ...
    public String getTEleven() {
        return TEleven;
    }

    public void setTEleven(String TEleven) {
